"""
This file contains the source code needed to download the `helm` command line tool and use `helm pull` to pull Helm
charts.
"""
...
helm_chart = repository_rule(
    ...
    attrs = {
        ...
        "reponame": attr.string(mandatory = True),
