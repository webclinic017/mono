"""
`go_repository_deps` loads all the relevant Go dependencies for gRPC and grpc-gateway
"""

load("@bazel_gazelle//:deps.bzl", "go_repository")

def go_repository_deps():
    """
    `go_repository_deps` loads all the relevant Go dependencies for gRPC and grpc-gateway
    """
    ...
    go_repository(
        ...
        sum = "h1:rGLEh2AWK4K0KCMvqWAz2EYxQqgciIfMagWZ0nVe5MI=",
        version = "v0.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:lWGiVt5CijhQAg0PWB7Od1RNcBw/jS4d2cAScBcSDXg=",
        version = "v1.3.9",
    )
    go_repository(
        name = "io_gorm_gorm",
